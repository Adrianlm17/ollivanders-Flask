...
def test_BackstagePasses(gilded_rose):
    assert (
        str(gilded_rose.items[5]) == "Backstage passes to a TAFKAL80ETC concert, 15, 20"
    )
    gilded_rose.updateGildedRose()
    assert (
        str(gilded_rose.items[5]) == "Backstage passes to a TAFKAL80ETC concert, 14, 21"
    )
    gilded_rose.updateGildedRose()
    assert (
        str(gilded_rose.items[5]) == "Backstage passes to a TAFKAL80ETC concert, 13, 22"
    )
    gilded_rose.updateGildedRose()
    assert (
        str(gilded_rose.items[5]) == "Backstage passes to a TAFKAL80ETC concert, 12, 23"
    )
    gilded_rose.updateGildedRose()
    assert (
        str(gilded_rose.items[5]) == "Backstage passes to a TAFKAL80ETC concert, 11, 24"
    )
...
def test_BackstagePasses_dos(gilded_rose):
    assert (
        str(gilded_rose.items[6]) == "Backstage passes to a TAFKAL80ETC concert, 10, 49"
    )
    gilded_rose.updateGildedRose()
    assert (
        str(gilded_rose.items[6]) == "Backstage passes to a TAFKAL80ETC concert, 9, 50"
    )
    gilded_rose.updateGildedRose()
    assert (
        str(gilded_rose.items[6]) == "Backstage passes to a TAFKAL80ETC concert, 8, 50"
    )
    gilded_rose.updateGildedRose()
    assert (
        str(gilded_rose.items[6]) == "Backstage passes to a TAFKAL80ETC concert, 7, 50"
    )
    gilded_rose.updateGildedRose()
    assert (
        str(gilded_rose.items[6]) == "Backstage passes to a TAFKAL80ETC concert, 6, 50"
    )
...
def test_BackstagePasses_tres(gilded_rose):
    assert (
        str(gilded_rose.items[7]) == "Backstage passes to a TAFKAL80ETC concert, 5, 49"
    )
    gilded_rose.updateGildedRose()
    assert (
        str(gilded_rose.items[7]) == "Backstage passes to a TAFKAL80ETC concert, 4, 50"
    )
    gilded_rose.updateGildedRose()
    assert (
        str(gilded_rose.items[7]) == "Backstage passes to a TAFKAL80ETC concert, 3, 50"
    )
    gilded_rose.updateGildedRose()
    assert (
        str(gilded_rose.items[7]) == "Backstage passes to a TAFKAL80ETC concert, 2, 50"
    )
    gilded_rose.updateGildedRose()
    assert (
        str(gilded_rose.items[7]) == "Backstage passes to a TAFKAL80ETC concert, 1, 50"
    )
